...
*   🐧 **Linux** — Ubuntu Server, пользователи, SSH, cron, диски, логи, hardening
*   📦 **Контейнеры** — Docker, Docker Compose, Helm, Kubernetes
*   📊 **Мониторинг** — Prometheus, Grafana, алерты, анализ логов
*   🌐 **Сеть** — Nginx, VPN, iptables, DHCP, reverse proxy
...
| --- | --- | --- |
| [linux-devops](https://github.com/putniikiis/linux-devops) | Админка Linux, bash-мониторинг, observability, сетевая лаборатория | Bash · Prometheus · Grafana · Nginx |
...
| Сертификат | PDF |
| --- | --- |
| Linux (D01) | [📄 d01-linux.pdf](certificates/d01-linux.pdf) |
| Linux Network (D02) | [📄 d02-linux-network.pdf](certificates/d02-linux-network.pdf) |
| Linux Monitoring (D03) | [📄 d03-linux-monitoring.pdf](certificates/d03-linux-monitoring.pdf) |
| Simple Docker (DO5) | [📄 do5-docker.pdf](certificates/do5-docker.pdf) |
| CI/CD (DO6) | [📄 do6-cicd.pdf](certificates/do6-cicd.pdf) |
| Docker Compose (DO7) | [📄 do7-docker-compose.pdf](certificates/do7-docker-compose.pdf) |
